...
public class Category {
    ...
    private String id;
    private String name;
    private ArrayList serviceReviewOperationsList;
    private HashMap<String, ArrayList<String>> operatorTrainingList2;

    public Category() {
    }

    public Category(String id, String name, ArrayList serviceReviewOperationsList, HashMap<String, ArrayList<String>> operatorTrainingList2) {
        this.id = id;
        this.name = name;
        this.serviceReviewOperationsList = serviceReviewOperationsList;
        this.operatorTrainingList2 = operatorTrainingList2;
    }
    ...
    public ArrayList getServiceReviewOperationsList() {
        return serviceReviewOperationsList;
    }

    public void setServiceReviewOperationsList(ArrayList serviceReviewOperationsList) {
        this.serviceReviewOperationsList = serviceReviewOperationsList;
    }

    public HashMap<String, ArrayList<String>> getOperatorTrainingList2() {
        return operatorTrainingList2;
    }

    public void setOperatorTrainingList2(HashMap<String, ArrayList<String>> operatorTrainingList2) {
        this.operatorTrainingList2 = operatorTrainingList2;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, category.id) &&
                ...
                Objects.equals(serviceReviewOperationsList, category.serviceReviewOperationsList) &&
                Objects.equals(operatorTrainingList2, category.operatorTrainingList2);
    }
    ...
    public String toString() {
        return "Category{" +
                "id='" + id + '\'' +
                ", name='" + name + '\'' +
                ", serviceOperationsList=" + serviceReviewOperationsList +
                ", trainingOperationsMap=" + operatorTrainingList2 +
                '}';
    }
}
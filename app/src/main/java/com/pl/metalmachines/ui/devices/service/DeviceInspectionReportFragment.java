...
//
        try {
            serviceOperationsList = CategoryDao.findCategoryByName(currentDevice.getCategoryName()).getServiceOperationsList();
...
// OK BUTTON //
    ...
    private boolean isAllChecked() {
        ...
        for (int j = 0; j < numberOfServiceCheckItems; j++) {
            ...
            if (radioGroup[j].indexOfChild(radio)==0){isExistIncorrect=true;}
